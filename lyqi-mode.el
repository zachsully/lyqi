...
(eval-when (load)
  ...
  (define-key lyqi:normal-mode-map "\C-c\C-c" 'lyqi:compile-ly)
  (define-key lyqi:normal-mode-map "\C-c\C-v" 'lyqi:open-pdf)
  (define-key lyqi:normal-mode-map "\C-c\C-l" 'lyqi:open-midi)
